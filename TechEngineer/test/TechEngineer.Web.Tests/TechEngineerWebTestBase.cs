...
{
    public abstract class TechEngineerWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TechEngineerWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TechEngineerWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TechEngineerDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TechEngineerDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TechEngineerDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TechEngineerDbContext, Task<T>> func)
        {
            T result;
